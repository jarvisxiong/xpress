		...
		$(document).ready(function() {
			...
			$("#inputForm").validate({
				rules: {
					...
					categoryId:{
						required: true,
						remote: "qidian-layout!checkCategoryId.action?deviceId=" + encodeURIComponent('${deviceId}') + "&oldCategoryId=" + encodeURIComponent('${categoryId}')
					},
					enable:"required"
				},
				messages: {
					categoryId: {
						remote: "This category has existed."
					}
				}
			});
		});
...
<div id="bd">
	<div id="yui-main">
	<div class="yui-b">
	<h2><s:if test="id == null">Add</s:if><s:else>Edit</s:else>&nbsp;Reading Layout</h2>
	<form id="inputForm" action="qidian-layout!save.action" method="post">
		...
		<table class="noborder">
			...
			<s:select name="categoryId" id="categoryId" listKey="id" listValue="name" list="#request.qidianCategoryList" label="Category" />
