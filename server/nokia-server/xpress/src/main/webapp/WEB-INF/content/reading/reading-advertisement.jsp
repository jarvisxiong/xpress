...
<head>
	...
	<script>
		$(document).ready(function() {
			$("#menu-reading-advertisement").addClass("active");
		});
	</script>
</head>
...
<div id="bd">
	<div id="yui-main">
	<div class="yui-b">
	<form id="mainForm" action="reading-advertisement.action" method="post">
					...
					<tr class=<s:if test="#rowStatus.odd">"oddRow"</s:if><s:else>"evenRow"</s:else>>
						...
						<td align="center">
							<security:authorize ifAnyGranted="ROLE_EditReading">
								<a href="reading-advertisement!input.action?id=${id}">Edit</a>&nbsp;&nbsp;
							</security:authorize>
						</td>
					</tr>
				</s:iterator>
