		...
		$(document).ready(function() {
			...
			$("#inputForm").validate({
				rules: {
					...
					deviceId:{
						required: true,
						remote: "news-provider-config!checkDeviceId.action?oldDeviceId=" + encodeURIComponent('${deviceId}')
					}
				},
				messages: {
					deviceId: {
...
<div id="bd">
	...
	<div class="yui-b">
	<h2>Edit Config</h2>
	<form id="inputForm" action="news-provider-config!save.action" method="post">
