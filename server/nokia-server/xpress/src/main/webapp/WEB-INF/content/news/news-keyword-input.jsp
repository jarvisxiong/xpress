...
<head>
	<title>NOKIA News Keyword Managemant</title>
	...
	<script>
		$(document).ready(function() {
			$("#menu-news-keyword").addClass("active");
			//聚焦第一个输入框
			$("#keyword").focus();
			...
			$("#inputForm").validate({
				rules: {
					keyword:{
						required: true,
						maxlength:64,
						remote: "news-keyword!checkKeyword.action?oldKeyword=" + encodeURIComponent('${keyword}')
					},
				},
				messages: {
					keyword: {
...
<div id="bd">
	...
	<form id="inputForm" action="news-keyword!save.action" method="post">
