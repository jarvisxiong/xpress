...
<head>
	<title>NOKIA Reading Keyword Managemant</title>
			...
			$("#inputForm").validate({
				rules: {
					keyword:{
						required: true,
						maxlength:64,
						remote: "reading-keyword!checkKeyword.action?oldKeyword=" + encodeURIComponent('${keyword}')
					},
				},
				messages: {
					keyword: {
...
<div id="bd">
	...
	<form id="inputForm" action="reading-keyword!save.action" method="post">
