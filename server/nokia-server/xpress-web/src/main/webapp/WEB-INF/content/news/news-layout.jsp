...
<div id="bd">
	<div id="yui-main">
	<div class="yui-b">
	<form id="mainForm" action="news-layout.action" method="post">
		...
		<div id="content">
			...
			<table id="contentTable" width="100%">
				<tr>
					...
					<th width="10%">Position Index</th>
					<th width="12%">Rss Name</th>
					<th width="6%">Rss State</th>
					<th width="4%">State</th>
				...
				<s:iterator value="page.result" status="rowStatus">
					<tr class=<s:if test="#rowStatus.odd">"oddRow"</s:if><s:else>"evenRow"</s:else>>
						...
						<td align="center">${rss.enable ? "enable":"disable"}</td>
						...
						<td align="center">
								<security:authorize ifAnyGranted="ROLE_EditNews">
									<a href="news-layout!input.action?id=${id}&deviceId=${deviceId}">Edit</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<a href="news-layout!delete.action?id=${id}&deviceId=${deviceId}" onclick="return confirm('Do you want to delete ${id}?')">Delete</a>
								</security:authorize>
						</td>
					</tr>
				</s:iterator>
		...
		<div>
			...
			<security:authorize ifAnyGranted="ROLE_EditNews">
				<s:if test="deviceId!=null">
					<a href="news-layout!input.action?deviceId=${deviceId}">Add</a>
				</s:if>
			</security:authorize>
		</div>
	</form>
